...
CREATE TABLE `tbl_admin_password` (
  `id_administrator_pwd` int NOT NULL,
  `normal_password` varchar(45) NOT NULL,
  PRIMARY KEY (`id_administrator_pwd`),
  KEY `id_admin_idx_admin_pwd` (`id_administrator_pwd`),
  CONSTRAINT `id_administrator` FOREIGN KEY (`id_administrator_pwd`) REFERENCES `tbl_administrator` (`id_administrator`)
...
INSERT INTO `tbl_admin_password` VALUES (1,'ridiculusmus'),(2,'acttouf'),(3,'auctorodio'),(4,'mauris125'),(5,'incondimentumdonec');
...
INSERT INTO `tbl_administrator` VALUES (1,'et.commodo.at@aol.couk'),(2,'sit@aol.org'),(3,'nunc@icloud.net'),(4,'elit.sed@yahoo.com'),(5,'quisque.fringilla.euismod@icloud.org');
...
INSERT INTO `tbl_attraction` VALUES (1,1,'101','台北有名的地理建築'),(2,1,'小巨蛋','台北有名的地理建築'),(3,1,'龍山寺','台北有名的歷史建築'),(4,2,'85','高雄有名的地理建築'),(5,2,'駁二','高雄有名的文藝景點'),(6,2,'愛河','高雄有名的地理建築'),(7,3,'鵝鑾鼻燈塔','屏東有名的地理建築'),(8,3,'墾丁大街','屏東有名的觀光景點'),(9,3,'海生館','屏東有名的觀光景點'),(10,4,'國家歌劇院','台中有名的文藝景點'),(11,4,'高美濕地','台中有名的地理建築'),(12,4,'三井outlet','台中有名的逛街景點'),(13,5,'藍田書院','南投有名的歷史建築'),(14,5,'茶二指','南投有名的文藝景點'),(15,5,'受天宮','南投有名的歷史建築');
...
CREATE TABLE `tbl_member_password` (
  `id_member_passward` int NOT NULL,
  `normal_pswd` varchar(45) NOT NULL,
  PRIMARY KEY (`id_member_passward`),
  KEY `id_Member_idx_pwd` (`id_member_passward`),
  CONSTRAINT `id_Member_pwd` FOREIGN KEY (`id_member_passward`) REFERENCES `tbl_member` (`id_member`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_member_password` VALUES (1,'sitamet'),(2,'mollis'),(3,'gravidanon'),(4,'elita'),(5,'uttincidunt'),(6,'quisquetincidunt'),(7,'aliquelobortis'),(8,'metusinlorem'),(9,'urna'),(10,'metusaliquam'),(11,'mloremvehicula'),(12,'massa'),(13,'adipiscingelitetiam'),(14,'lectusnullamsuscipit'),(15,'donecfeugiatmetus'),(16,'arcuvestibulum'),(17,'interdumenim'),(18,'velitaliquanisl'),(19,'dictumauguemalesuada'),(20,'iaculisaliquet'),(21,'necorci'),(22,'acfermentum'),(23,'habitant'),(24,'tellususpendissesed'),(25,'loerjeo');
...
INSERT INTO `tbl_picture` VALUES (1,1,'https://img.onl/8aw6Hy'),(2,3,'https://img.onl/kSaVGL'),(3,4,'https://img.onl/4J4W4A'),(4,5,'https://img.onl/kFvOEv'),(5,8,'https://img.onl/7vWwql'),(6,9,'https://img.onl/bQc7OE'),(7,10,'https://img.onl/Zw78VZ'),(8,12,'https://img.onl/2I2UR8'),(9,13,'https://img.onl/XLX8gX'),(10,15,'https://img.onl/mYets');
...
INSERT INTO `tbl_project` VALUES (1,1,'高雄一日遊','2022-12-08 00:00:00',NULL,'2022-12-31 00:00:00','2022-12-31 00:00:00',2),(2,2,'南投兩日遊','2023-01-01 00:00:00',NULL,'2023-01-02 00:00:00','2023-01-04 00:00:00',5);
...
INSERT INTO `tbl_project_attraction` VALUES (1,1,'2022-12-31 00:00:00','2022-12-31 01:00:00'),(1,2,'2022-12-31 01:30:00','2022-12-31 02:00:00'),(1,3,'2022-12-31 03:00:00','2022-12-31 03:30:00'),(2,4,'2023-12-31 00:00:00','2023-12-31 01:00:00'),(2,5,'2023-12-31 01:30:00','2023-12-31 02:00:00');
...
-- Dump completed on 2022-12-07 23:45:11
